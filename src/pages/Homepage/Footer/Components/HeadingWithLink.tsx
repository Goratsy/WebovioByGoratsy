...
const HeadingWithLink: FunctionComponent = () => {
    ...
    return (
        <div
            ref={ref}
            className={`w-[88.5%] pl-[11.5%] max-tablet:pl-[5%] py-[7rem] absolute top-0 left-0 bg-background-secondary z-50 -translate-y-1/2 shadow-[50px_130px_100px_rgba(0,0,0,0.15)]`}
        >
