            ...
            <section className="pt-[15rem]">
                ...
                <div className="relative px-[11.5%] grid grid-cols-4 grid-rows-1 justify-between items-center gap-[2.7%]">
                    {cards.map((card, index) => {
                        return (
                            <div key={index} className="relative rounded-xl h-[31rem] p-[3rem] shadow-[0px_0px_0px_rgba(0,0,0,0.3)] duration-300 ease-in-out hover:-translate-2 hover:shadow-[20px_20px_50px_rgba(0,0,0,0.15)]">
